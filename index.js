...
console.log('task 6:', addArtist(artists, 'Patrick Miller', '1996 - Present', 'Film', 'African American', 'I went to film school, but becuase the work is not consistent, I decided to switch careers!'))
...
function lotsOfArt(array) {
  ...
  for (let i = 0; i < array.length; i++){
    if (array[i].paintings > 100){
      lotOFPaintings.push(array[i].name);
    } 
  }
...
console.log('Task 9', artists, 'Spanish')
